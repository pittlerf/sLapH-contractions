...
void DilutedTraceCollection<DilutedFactorType::Q0, DilutedFactorType::Q2, 2>::build(
                 std::vector<DiagramIndex> const &trQ0Q2_index_collection,
                 int const t1,
                 int const t2,
                 int const b1,
                 int const b2) {

  for (const auto &c_look : trQ0Q2_index_collection) {
...
void DilutedTraceCollection<DilutedFactorType::Q1, DilutedFactorType::Q1, 2>::build(
                 std::vector<DiagramIndex> const &trQ1Q1_index_collection,
                 int const t1,
                 int const t2,
                 int const b1,
                 int const b2) {

  for (const auto &c_look : trQ1Q1_index_collection) {
