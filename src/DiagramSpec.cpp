...
BuildLookupLookupMap make_build_lookup_lookup_map() {
  ...
  map["C1"] = {Vertices({0}, {}), {{{"Q1", 0, 0}}}};

  map["C20"] = {Vertices({0}, {1}), {{{"Q1", 0, 1}, {"Q1", 1, 0}}}};

  map["C2c"] = {Vertices({0}, {1}), {{{"Q0", 0, 1}, {"Q2V", 1, 0}}}};

  map["C20V"] = {Vertices({0}, {1}), {{{"Q1", 0, 0}}, {{"Q1", 1, 1}}}};

  map["C30"] = {Vertices({0, 2}, {1}), {{{"Q1", 2, 0}, {"Q1", 0, 1}, {"Q1", 1, 2}}}};

  map["C3c"] = {Vertices({0, 2}, {1}), {{{"Q2L", 2, 0}, {"Q1", 0, 1}, {"Q0", 1, 2}}}};

  map["C30V"] = {Vertices({0, 1}, {2}), {{{"Q1", 0, 1}, {"Q1", 1, 0}}, {{"Q1", 2, 2}}}};
